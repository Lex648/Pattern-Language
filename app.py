    ...
    messages = [
        {"role": "system", "content": V4_SYSTEM_PROMPT},
        {
            ...
            "content": (
                ...
                "Zoek voor elk patroon de fysieke drager van het concept.\n"
                "Als het onderwerp abstract is (bijv. 'Kracht'), zoek naar plekken, objecten of "
                "handelingen waar dit zichtbaar wordt (zoals ontmoetingsplek, drempel, gereedschap).\n"
                "Verbied standaard natuurmetaforen (water, bergen, stormen) tenzij het onderwerp "
                "letterlijk over natuur gaat.\n"
                "Titels moeten klinken als hoofdstukken uit 'A Pattern Language': zelfstandige "
                "naamwoorden die een plek of ding aanduiden.\n"
